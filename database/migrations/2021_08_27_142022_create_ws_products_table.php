...
class CreateWsProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ws_products', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('pdt_parent')->nullable()->default(null);
            ...
            $table->text('pdt_conten')->nullable()->default(null);
            $table->decimal('pdt_price', 11, 2)->nullable()->default(null);
            $table->decimal('pdt_inventory', 10, 0)->nullable()->default(0);
            $table->decimal('pdt_delivered', 10, 0)->nullable()->default(0);
            $table->unsignedInteger('pdt_brand')->nullable()->default(null);
            ...
            $table->decimal('pdt_dimension_heigth', 11, 0)->nullable()->default(0);
            $table->decimal('pdt_dimension_width', 10, 0)->nullable()->default(0);
            $table->decimal('pdt_dimension_depth', 11, 0)->nullable()->default(0);
            $table->decimal('pdt_dimension_weight', 11,0)->nullable()->default(0);
            ...
            // $table->foreign('pdt_brand')->references('brand_id')->on('ws_products_brands')->onDelete('set null');
